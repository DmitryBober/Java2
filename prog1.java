...
Далее создайте метод, который запишет результат работы в файл. 
Обработайте исключения и запишите ошибки в лог файл с помощью Logger.
 */

 public class prog1 {
    public static void main(String[] args) throws Exception {
        String [] arrayData =  prog.ReadLineFromFile("prog1.txt");
